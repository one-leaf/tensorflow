...
1. 长短期记忆和其他门控RNN
    ...
    1. LSTM
        ...
        digraph rnn_iteration{
            ...
            x0->x1->h1->h3->o
            x0->x2->h1 [constraint=false]
            h2->h3 [constraint=false]
            x0->x3->h2 [constraint=false]
            x4->o  [constraint=false]
            x0->{x4} [constraint=false]
            h3->{x2;x3;x4}  [constraint=false]
            h3->h4->h2 [constraint=false]
            o->L
        ...
        第一步是构造遗忘门，将隐含层和当前数据用$\sigma$组合起来，构成了一个权重 $f_{i,t}$ 代表 时刻 t 和 细胞 i。
