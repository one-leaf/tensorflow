...
ds=dataset()
class network():
    def add_rnn_layer(self, inputs, batch_size, cell_num, reverse=False):
    ...
    def __init__(self):
        ...
        layer1, _ =  self.add_rnn_layer(self.x, self.batch_size, ds.chars_length//2, False)
        layer2, _ =  self.add_rnn_layer(self.x, self.batch_size, ds.chars_length//2, True)

        self.pred = tf.concat([layer1,layer2],-1)
