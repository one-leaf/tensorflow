...
class network():
    ...
    def __init__(self):
        ...
        self.student_optimizer= tf.train.AdamOptimizer(0.01).minimize(self.student_cross_entropy+10*self.teacher_student_loss, var_list=student_vars)
        
        self.teacher_optimizer= tf.train.AdamOptimizer(0.01).minimize(self.teacher_cross_entropy+10*self.teacher_student_loss)
