...
- 实用举例
    ...
    $$y=X*w+b=\begin{bmatrix} x_{(1)} \cdots x_{(784)} \end{bmatrix}  * \begin{bmatrix} w_{(1,1)}&...&w_{(1,10)}\\ \vdots &\vdots &\vdots \\ w_{(784,1)}&...&w_{(10,784)} \end{bmatrix} + \begin{bmatrix} b_{(1)} \cdots b_{(10)}\end{bmatrix}$$
