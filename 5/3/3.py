...
# CNN网络
def get_network(x, output_size, filter_size=[8,5,5,3,3,3,3,3,3,3], filter_nums=[128,128,128,128,128,128,128,128,128,128], pool_scale=[2,2,2,2,2,2,2,2,2,2], pool_type=[0,0,1,0,0,1,0,1,0,1],full_nums=1024, output_name="output_layer"):
