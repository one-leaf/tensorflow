...
# CNN网络
def get_network(x, output_size, filter_size=[3,3,3,3,3], strides_size=[1,1,1,1,1], filter_nums=[64,64,64,64,64], pool_scale=[-1,-1,-1,-1,-1], pool_type=[1,1,1,1,1],full_nums=384, output_name="output_layer"):
