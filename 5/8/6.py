...
def network():
    ...
    net_class_fc = paddle.layer.fc(input=block_expand, size=nets_class, act=paddle.activation.Softmax())
    net_box_fc = paddle.layer.fc(input=block_expand, size=nets_box, act=paddle.activation.Tanh())
