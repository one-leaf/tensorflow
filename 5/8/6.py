...
def network():
    ...
    gru_forward = paddle.networks.simple_gru(input=nets_class, size=128, act=paddle.activation.Relu())
    ...
    gru_forward = paddle.networks.simple_gru(input=nets_box, size=128, act=paddle.activation.Relu())
