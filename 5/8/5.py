        ...
        for i, data in enumerate(training_data):
            ...
            for i in range(w):
                ...
                if i > train_size: 
                    ...
                    if c > 20 and s == train_size and random.random>0.5: continue
                    if c < -20 and s == 0 and random.random>0.5: continue                    
...
print('set reader ...')
train_reader = paddle.batch(paddle.reader.shuffle(reader_get_image_and_label(), buf_size=81920), batch_size=64)
