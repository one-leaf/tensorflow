...
def resnet_cifar10(ipt, depth=32):
    ...
    pool = paddle.layer.img_pool(input=res3, pool_size=4, pool_size_y=1, stride=4, pool_type=paddle.pooling.Avg())
    return pool
...
def network():
    ...
    layer = resnet_cifar10(x, 20)   #1*1*64
