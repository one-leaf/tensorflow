...
def neural_networks():
    ...
    return inputs, labels, global_step, mse_loss, g_optim_init, d_loss, d_optim, g_loss, mse_loss, vgg_loss, g_gan_loss, g_optim, net_g
...
def train():
    global_step = tf.Variable(0, trainable=False)
    inputs, labels, global_step, mse_loss, g_optim_init, d_loss, d_optim, g_loss, mse_loss, vgg_loss, g_gan_loss, g_optim, net_g = neural_networks()
